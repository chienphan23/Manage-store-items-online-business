...
/**
 * Servlet implementation class imageThemHangController
 */
@WebServlet("/imageThemHangController")
public class imageThemHangController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public imageThemHangController() {
		super();
