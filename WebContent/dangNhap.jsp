...
<div class="m-4 navbar-header-css" style="margin: 0 !important;color: white !important">
	...
	<h1 style="text-align: center;margin: 20px">Đăng nhập</h1>
	...
	<div class="col-lg-4" style="text-align: left">
		...
		<%} %>
		<a href="dangKyController" class="text-primary">Bạn chưa có tài khoản? </a><br>
			<a href="adminDangNhapController" class="text-primary">Đăng nhập với tư cách quản lý</a>
